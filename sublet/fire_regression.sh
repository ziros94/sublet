#!/bin/bash
#This script runs "dump2CSV.py",to export apartment feature and matching price data from db;
#runs "regression.py" to takes in .csv and outputs regression result to parameters.txt
